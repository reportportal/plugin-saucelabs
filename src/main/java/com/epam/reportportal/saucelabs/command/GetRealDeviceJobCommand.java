 ...
 */
@Slf4j
public class GetRealDeviceJobCommand extends AbstractExtensionCommand<Object> {

  private final RestClientBuilder restClient;


  public GetRealDeviceJobCommand(RestClientBuilder restClient, ProjectRepository projectRepository,
