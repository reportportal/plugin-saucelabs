 ...
 */
@Slf4j
public class GetLogsCommand extends AbstractExtensionCommand<Object> {

  private final RestClientBuilder restClient;

  public GetLogsCommand(RestClientBuilder restClient, ProjectRepository projectRepository,
